...
export default function Footer() {
  ...
  return (
    <div className='bg-[url("/footer-gradiant.png")] bg-cover bg-center font-[norms-pro] text-white border-t border-[#434343]'>
      <footer className='relative text-white pt-10 sm:pt-12 lg:pt-16 pb-4 sm:pb-6 lg:pb-8 px-4 sm:px-6 md:px-12 overflow-hidden'>
        {/* Main Content */}
      ...
      {/* Bottom bar */}
      <div className='bg-[#242424] mx-auto text-xs sm:text-sm text-gray-500 mt-8 sm:mt-10 md:mt-12 relative z-10'>
