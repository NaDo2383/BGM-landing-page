    ...
    <section
      ...
      <div
        className='
          ...
          gap-8 sm:gap-12 lg:gap-[196px]
        '>
        {/* Left title column */}
        <div className='px-1'>
          <h2
            className='
              font-[Roboto] text-white leading-tight capitalize
        ...
        <div className='w-full max-w-3xl mx-auto px-0 sm:px-2'>
          <div
            role='list'
            className='rounded-xl border border-[#314158]/50 overflow-hidden divide-y divide-[#314158]/60'>
            {faqs.map((faq, index) => {
              ...
              return (
                <div key={index} role='listitem' className='bg-[#020618]'>
                  <button
                    id={btnId}
